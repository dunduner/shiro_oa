...
<div class="layui-form">
    <div class="form-group">
        <label>介质编码:<input class="form-control" type="text" name="jzbm" id="jzbm" lay-verify="jzbm" /></label>
    </div>
    <div class="form-group">
        <label>介质类型:<textarea rows="1" cols="17" id="jzlx" name="jzlx" class="form-control"
                              lay-verify="jzlx"></textarea></label>
    </div>
