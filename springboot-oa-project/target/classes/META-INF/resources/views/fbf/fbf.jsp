    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body form-group" style="margin-bottom:0px;">
                <label class="col-sm-2 control-label" style="text-align: right; margin-top:5px">发包方姓名：</label>
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="fbfmc" id="search_fbfmc"/>
                </div>
...
<script type="text/javascript">
    ...
    $("#btn_add").click(function () {
        window.location.href = "${ctx}/fbf/addFbf?flag=1";
    })
    ...
    $("#btn_delete").click(function () {
        var ids = getIds();
        if (ids.length < 1) {
            layer.alert('请选择至少一个发包方!', {
                skin: 'layui-layer-lan'
                , closeBtn: 0
            })
        } else {
            layer.confirm('确定删除这些发包方吗?？', {
                btn: ['是的', '按错了'] //可以无限个按钮
            }, function () {
                //确定按钮的回调函数
                var url = "${ctx}/fbf/removeFbf";
                var params = {
                    flag: 2,
                    ids: ids
                }
    ...
    function deleteone(id) {
       layer.confirm('确定删除这个发包方吗?', {
            btn: ['是的', '按错了'] //可以无限个按钮
        }, function () {
            //确定按钮的回调函数
            window.location.href = "${ctx}/fbf/removeFbf?flag=1&id=" + id;
        })
    };
        ...
        inint() {
            ...
            this.obj.bootstrapTable({
                ...
                columns: [
                    ...
                    {field: 'fbfmc', title: '发包方姓名'},
                    {field: 'fbfzjhm', title: '发包方证件号码'},
                    {field: 'fbflxdh', title: '发包方联系电话'},
                    {field: 'fbfdz', title: '发包方地址'},
                    {
