    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body form-group" style="margin-bottom:0px;">
                <label class="col-sm-2 control-label" style="text-align: right; margin-top:5px">承包方姓名：</label>
                <div class="col-sm-2">
                    <input type="text" class="form-control" name="cbfmc" id="search_cbfmc"/>
                </div>
...
<script type="text/javascript">
    ...
    $("#btn_add").click(function () {
        window.location.href = "${ctx}/cbf/addCbf?flag=1";
    })
    ...
    $("#btn_delete").click(function () {
        var ids = getIds();
        if (ids.length < 1) {
            layer.alert('请选择至少一个承包方!', {
                skin: 'layui-layer-lan'
                , closeBtn: 0
            })
        } else {
            layer.confirm('确定删除这些承包方吗?？', {
                btn: ['是的', '按错了'] //可以无限个按钮
            }, function () {
                //确定按钮的回调函数
                ...
                $.ajax({
                    ...
                    success:function(data){
                    	if(data=="success"){
                    		setTimeout(function(){
                    			$("#table").bootstrapTable("refresh", {url: '${ctx}/cjson'});
                    		},1000);
    ...
    function deleteone(id) {
       layer.confirm('确定删除这个承包方吗?', {
            btn: ['是的', '按错了'] //可以无限个按钮
        }, function () {
            //确定按钮的回调函数
            window.location.href = "${ctx}/cbf/removeCbf?flag=1&id=" + id;
        })
    };
        ...
        inint() {
            ...
            this.obj.bootstrapTable({
                ...
                columns: [
                    ...
                    {field: 'cbfbm', title: '承包方编码'},
                    {field: 'cbfmc', title: '承包方名称'},
                    {field: 'cbflx', title: '承包方类型'},
                    {field: 'cbfzjhm', title: '承包方证件号码'},
                    {field: 'lxdh', title: '承包方联系电话'},

                    {
                        field: 'tool', title: '操作', align: 'center',
                        formatter: function (value, row, index) {
                            var element =
                                "<a  data-id='" + row.id + "' href='${ctx}/fbf/updateFbf?flag=1&id=" + row.id + "' class='btn btn-info btn-sm'>编辑</a> &nbsp;" +
